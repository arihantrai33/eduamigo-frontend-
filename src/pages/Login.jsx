...
const s = {
  page: { minHeight: "100vh", height: "100vh", display: "flex", flexDirection: "column", background: "linear-gradient(160deg, #0f1b4c 0%, #1a3a8f 50%, #0f1b4c 100%)", fontFamily: "'Inter','Segoe UI',sans-serif", overflowY: "auto" },
  top: { display: "flex", flexDirection: "column", alignItems: "center", padding: "20px 24px 16px", position: "relative" },
  ...
  forgot: { fontSize: 12, color: "#4f8ef7", cursor: "pointer", fontWeight: 600 },
  ...
  footer: { textAlign: "center", marginTop: 18, fontSize: 11, color: "var(--subtext)" },
};
