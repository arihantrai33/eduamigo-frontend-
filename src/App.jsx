...
function AppLayout() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f0f1a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: 390, height: '100vh', maxHeight: 844, position: 'relative', overflow: 'hidden', background: '#F4F6FB', boxShadow: '0 40px 100px rgba(0,0,0,.6)', borderRadius: 40 }}>
        <AppRoutes />
      </div>
    </div>
  )
